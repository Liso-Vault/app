...
class AppConfigService extends GetxService with ConsoleMixin {
  ...
  static void onRemoteConfigFetched() {
    // final console = Console(name: 'AppConfigService');
    // console.info('onRemoteConfigFetched');
  }
}
